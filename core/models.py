...
class Resume(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='core_resumes')
...
class Submission(models.Model):
    ...
    uuid = models.UUIDField(default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='core_submissions')
...
def create_or_save_core_profile(sender, instance, created, **kwargs):
